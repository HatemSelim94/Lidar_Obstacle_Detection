...
Hyperparameters:
   ...
   - Clustering3D:
          0.5 is the distance threshold in meter.
          10  is the minimum number of points to construct a cluster.
          150 is the maximum number of points to construct a cluster.
*/
...
void simpleHighway(pcl::visualization::PCLVisualizer::Ptr& viewer)
{
    ...
    // render segementation output
    //renderPointCloud(viewer, segmentCloud.first, "obstCloud", Color(1,0,0));
    renderPointCloud(viewer, segmentCloud.second, "planeCloud", Color(0,1,0));

    // render clustering output
    // cluster the obstacle cloud points
